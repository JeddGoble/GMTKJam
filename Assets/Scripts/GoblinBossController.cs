...
public class GoblinBossController : BaseEnemy
{
	...
	public float MaxRangeToPlayer = 9f;

	public Rigidbody2D arrowRB;

	public float ArrowForce = 500f;
	public float ArrowMaxFrequency = 5f;
	...
	{
		print("Attempting to fire arrow");
		...
		if (arrowRB != null)
		{
			...
			print("Successfully fired arrow");
		}
	}
